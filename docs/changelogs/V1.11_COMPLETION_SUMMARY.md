...
v1.11.0 successfully implements **advanced parameter types** for OpenSCAD Assistive Forge, adding native support for **color picker** and **file upload** parameters. This release enables richer parametric models with visual customization and data import capabilities.
